...
public class Project implements Serializable {
    ...
    public String toString() {
        return "Project{" + "id=" + id + ", project_name=" + project_name + ", description=" + description + ", job_type=" + job_type + ", job_rate=" + job_rate + ", employer=" + employer + ", skills=" + skills + ", status=" + status + ", freelancer=" + freelancer + ", created_at=" + created_at + ", updated_at=" + updated_at + ", bid_count=" + bid_count + ", avg_rate=" + avg_rate + '}';
    }
}
