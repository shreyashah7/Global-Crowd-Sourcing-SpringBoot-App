...
class PostProject extends Component {
    ...
    handleSubmit(e) {
        ...
        const { project_name, description, skills, job_rate } = this.state;
       
        if (project_name && description && skills && job_rate) {
            let projectObject = this.state;
            projectObject.employer = UserHelper.getUserObject().id;
                ...
                <div className="col-md-offset-3 col-md-6">
                    <form name="form" className="login-form" onSubmit={this.handleSubmit}>
                        ...
                        <section>
                            ...
                            <div className={(this.state.submitted && !this.state.project_name ? ' has-error' : '')}>
                                <input type="text"
                                ...
                                {this.state.submitted && !this.state.project_name &&
                        ...
                        <section>
                            ...
                            <div className="radio">
                                <input id="radio-1"
                                    ...
                                    type="radio"
                                    value="HOURLY"
                                    checked={this.state.job_type === 'HOURLY'}
                                    onChange={(event) => {
                                        this.setState({
                            ...
                            <div className="radio">
                                <input id="radio-2"
                                    ...
                                    type="radio"
                                    value="FIXED"
                                    checked={this.state.job_type === 'FIXED'}
                                    onChange={(event) => {
                                        this.setState({
                                            job_type: event.target.value
                                        })
                        ...
                        <section className="clearfix">
                            ...
                            <div className="col-md-12 pd-left-0">
                                ...
                                <div className="col-md-4 pd-left-0">
                                    <div className={(this.state.submitted && !this.state.job_rate ? ' has-error' : '')}>
                                        <input type="text"
                                            ...
                                            onChange={(event) => {
                                                this.setState({
                                                    job_rate: event.target.value
                                                })
                                            }} />
                                        {this.state.submitted && !this.state.job_rate &&
