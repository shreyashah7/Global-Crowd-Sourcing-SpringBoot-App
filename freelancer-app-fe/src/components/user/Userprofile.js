                        ...
                        <div className="contact">
                            <div className="controls">
                                ...
                                <div className="cont">
                                    ...
                                    <div className="name"><span className="s-text">{this.state.user.first_name + " " + this.state.user.last_name}</span></div>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-8 col-md-7 col-xs-12">
                                    <p className="contact-description">{this.state.user.about_me}</p>
                                </div>
                            </div>
                        </div>
                        <br/>
